...
namespace Datos.Repositorys
{
    ...
    public class UsuarioActividadRepository
    {
        ...
        /// </summary>
        /// <param name="usuarioActividad">Un objeto <c>Usuario_Actividad</c> que representa la actividad a eliminar.</param>
        /// <returns>Devuelve <c>true</c> si la actividad fue eliminada correctamente, de lo contrario <c>false</c>.</returns>

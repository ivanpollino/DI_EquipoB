    ...
    public partial class Login : Form
    {
        ...
        private void BTNAlternarContrasena_Click(object sender, EventArgs e)
        {
            if (TXTBPass.PasswordChar == '\0')
            {
                ...
                BTNAlternarContrasena.Image = global::Presentacion.Properties.Resources.contraVisible;
            }
            else
            {
                TXTBPass.PasswordChar = '\0';
                BTNAlternarContrasena.Image = global::Presentacion.Properties.Resources.contraNoVisible;
            }
        }

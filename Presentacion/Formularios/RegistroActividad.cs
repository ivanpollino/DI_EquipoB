...
{
    public partial class RegistroActividad : Form
    {
        ...
        /*private void LlenarComboBoxMonitores()
        {
            cbMonitores.Items.Clear();
            cbMonitores.Items.Add("1234567890"); 
            cbMonitores.Items.Add("0987654321");  
            cbMonitores.Items.Add("1122334455");  
            cbMonitores.Items.Add("2233445566"); 
        }*/
